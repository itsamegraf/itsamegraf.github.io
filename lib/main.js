...
import { gsap, PixiPlugin } from '@gsap';
...
(async () =>
{
    ...
    async function scene1() {
        ...
        timeline
            ...
            .add(world.petitMe.jumpInto(
                world.rc.cart.childrenContainer, 
                world.rc.cart.sprite.height), '<+25%')
            // start animating rc
            .add(world.rc.createAnimations(world.camera.updatePosition))

...
(async () =>
{
    ...
    async function scene1(delta) {
        ...
        let cartAnimationTimeline = world.rc.cart.animateAlongTrack();
        ...
        timeline
            ...
            // start animating cart
            .add(cartAnimationTimeline, '>')
            // move world camera
            .to(world.container, {
                pixi: {pivotX: world.rc.track.getBuiltTrackWidth()},
                duration: cartAnimationTimeline.duration()
            }, '<+10%') // 1 second difference from start
